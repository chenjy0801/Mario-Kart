...
from train import create_model, is_valid_track_code, IN_DEPTH, INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS
...
class TCPHandler(StreamRequestHandler):        
    def handle(self):
        try:
            ...
            print('initialization imgae predioction')
        ...
        for line in self.rfile:
            ...
            if message.startswith("PREDICTFROMCLIPBOARD"):
                ...
                if im != None:
                    prediction = model.predict(prepare_image(im,im_prd), batch_size=1)[0]
            ...
            if message.startswith("PREDICT:"):
                ...
                prediction = model.predict(im_prd, batch_size=1)[0]
                self.wfile.write((str(prediction[0]) + "\n").encode('utf-8'))
